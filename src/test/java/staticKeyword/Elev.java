...
public class Elev {
    ...
    //Static e o alta modalitate de a face share la o variabila/metoda dintr-o clasa
    //Practic putem considera ca fiind pastrarea valorilor pentru toate obiectele definite

    private String nume;
    private String prenume;
    private Integer varsta;
    private static String scoala = "Mihai Bravu";
    ...
    public void prezentare(){
        ...
        System.out.println("Nr de elevi la scoala este: " + nrElevi);
    }
}
